<?php if (!$settings["back_operation"]) { ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="page-title clearfix panel-heading pdocrud-table-heading h-56">
            <div class="row">
            <div class="col-xs-5">
             ...
             if (isset($extraData["btnTopAction"]) && is_array($extraData["btnTopAction"]) && count($extraData["btnTopAction"])) { 
                foreach ($extraData["btnTopAction"] as  $action_name => $action) { 
                    list( $key, $text, $attr, $url, $cssClass) = $action;
                     ?>
                    <div class="btn-group pull-right">
                        <a  title="<?php echo $text; ?>" class="pdocrud-top-actions pdocrud-button pdocrud-button-<?php echo $action_name; ?> btn btn-success"  
                            href="<?php echo $url;?>"
                            data-action="<?php echo $action_name; ?>" data-obj-key="<?php echo $objKey; ?>">
                            <i class="<?php echo $cssClass; ?>"></i> <?php echo $text; ?>
                        </a>                    
                    </div>
               <?php } 
                }
            ?>
                <?php if ($settings["addbtn"]) { ?>
                    <a style="float: right;" title="<?php echo $lang["add"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-add btn btn-success" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        <?php echo $lang["add"]; ?>
                    </a> 
                <?php } ?>
            ...
            <div class="row" style="padding-bottom: 5px">
                <?php foreach($extraData["dateRangeReport"] as $key => $dateRange ) {?>
                        <div class="col-md-2 col-lg-2">
                            <a title="<?php echo $dateRange["text"]; ?>" class="pdocrud-actions pdocrud-button  btn btn-info btn-sm pdocrud-date-range-report"
                    ...
                    <div class="col-sm-6">
                        <ul class="pdocrud-export-options">
                            <?php if ($settings["printBtn"]) { ?>
                                <li class="btn btn-default"><a title="<?php echo $lang["print"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="print" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["pdfBtn"]) {
                                ?>
                                <li class="btn btn-default"><a title="<?php echo $lang["pdf"]; ?>"class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="pdf" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["excelBtn"]) { ?>
                                <li class="btn btn-default"><a title="<?php echo $lang["excel"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>">
                                        <i class="fa fa-file" aria-hidden="true"></i>
                                            <?php echo $lang["excel"]; ?>
                                    </a>
                                </li>
