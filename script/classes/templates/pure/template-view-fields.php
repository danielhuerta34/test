            ...
            <td class="text-right">                        
                <div class="pdocrud-action-buttons pdocrud-button-delete">
                    ...
                    <?php } ?>
                     ...
                     <button data-action="close" data-dismiss="modal" class="btn btn-info pdocrud-form-control pdocrud-button pdocrud-close" type="button"><?php echo $lang["back"] ?></button>
                    <?php } ?>
                </div>                         
            </td>
        </tr>
